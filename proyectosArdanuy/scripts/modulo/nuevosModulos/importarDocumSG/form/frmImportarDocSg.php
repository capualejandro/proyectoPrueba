...
<body>
   ...
   <table cellpading="5" cellspacing="0" align="center" width="43%">
    ...
    <tr>
     ...
     <td width="68%" align="left">
      <select name="selTipDocSG" id="selTipDocSG" class="" style="width: 250px;">
       ...
       <option value='PLAN_DE_EMERGENCIAS'>Plan de Emerg</option>
       <option value='COMITE_DE_CONVIVENCIA'>Comite Convivencia</option>
    ...
    <tr>
     ...
     <td width="68%" align="left">
      <input type="file" id="filDocSG" name="filDocSG" class="" />
      <span id="status"></span>
     </td>
    </tr>
