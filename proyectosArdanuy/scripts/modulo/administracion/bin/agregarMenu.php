<?php
	...
	if($txtBandera!=""){
		...
		if ($varCont != 0){
			...
			$caSql = "INSERT INTO modulo (mod_codigo, mod_padre, mod_archivo, mod_descripcion, mod_ordenpadre, mod_orden, mod_visible) VALUES ('$txtNombre', '$selPadre', '$txtHTMLMenu', '$txtDescripcion', '$txtOrdenPadre', '$txtOrdenMenu', '$selAccesoPublico')";
			$db->Execute($caSql);
#			echo $caSql; exit();
