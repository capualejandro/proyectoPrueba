...
//							alert('Error Sofia');
			...
			$("#enviar").click(function (){
                ...
                if($("#selCodProyecto").val()==""){
                    ...
                    $("#selNumFact").focus().after("<span class='error'>Seleccione el número de la factura</span>");
                    return false;
                    ...
                    $("#txtValFact").focus().after("<span class='error'>Ingrese el valor consignado</span>");
                    return false;
                }else if($("#txtValFact").val() > $("#hidValFact").val()){
                    $("#txtValFact").focus().after("<span class='error'>El valor del pago no debe ser mayor al de Factura</span>");
                    return false;
				}else{
//					alert(" OK "+$("#txtPorProy").val()+" "+$("#txtValProy").val());
					$('#txtBandera').attr({'value':'1'});
					$('#frmCrearPago').attr('action','./index.php?seccion=CREAPAGO');
					$('#frmCrearPago').submit();
                }
			});	
        ...
        <form id="frmCrearPago" name="frmCrearPago" method="post">
        	...
        	<table cellpading="5" cellspacing="0" align="center" width="43%">
                <tr>
                  <td colspan="3" class="subtexto">
                    ...
                    <table width="100%" border="0" align="center" cellspacing="0" cellpading="5">
                      <tr>
                        <td width="76%" align="center"><h2 class="titulo"><font color="#CC0000">Crear Pagos Factura</font></h2></td>
                ...
                <tr>
                    ...
                    <td width="26%" align="left"><label class="subtexto"><font color="#005199">Numero Factura<font color="red">*</font></label></td>
                ...
                <tr>
                    <td align="left">&nbsp;</td>
                    <td width="26%" align="left"><label class="subtexto"><font color="#005199">Fecha Pago<font color="red">*</font></label></td>
                    <td width="68%" align="left">
                ...
                <tr>
                    <td align="left">&nbsp;</td>
                    <td width="26%" align="left"><label class="subtexto"><font color="#005199">Valor Consignado<font color="red">*</font></label></td>
                    <td width="68%" align="left">
