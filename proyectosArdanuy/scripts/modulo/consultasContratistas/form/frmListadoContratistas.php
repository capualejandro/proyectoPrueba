...
<title></title>
	...
	<script type="text/javascript" src="../scripts/modulo/consultasContratistas/lib/listadoProyectos.js"></script>
...
<body>
	...
	<div id="content">
   <h2 class="titulo" align="center"><font color="#cc0000">Listado De Contratistas</font></h2>
  	<div id="filtros">
   	<center>
    	<form id="frmListadoContratistas" name="frmListadoContratistas" method="POST">
     ...
     <b>
      ...
      <label class="subtexto"><font FACE="arial" zice="5" color="#005199">Contratista:</font></label>
      <input type="text" name="txtCliente" id="txtCliente" size="35" class="subtexto" />
