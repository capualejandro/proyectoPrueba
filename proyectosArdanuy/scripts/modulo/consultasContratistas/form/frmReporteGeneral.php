  ...
  <table cellspacing="0" cellpadding="5" border="0" width="950" class="textopequeno" id="datos" align="center">
    ...
    <td align="center">
      <table cellspacing="0" cellpadding="5" border="1" width="950" class="textopequeno">
        ...
        <tr><td bgcolor="#E9E9E9" colspan="6"><strong><font FACE="arial" zice="5" color="#005199">Empresa Contratante</font></strong></td></tr>
        <tr>
        	<td colspan="6">
        ...
        <tr>
        	<td class="ardanuy" colspan="3" width="39%">Ampliaciones del Proyecto</td>
        	<td class="ardanuy" width="25%">Fecha Contrato</td>
         <td class="ardanuy" colspan="2">Fecha Suspensión y terminación</td>
        </tr>
        <tr>
...
#				$valEuroActual=numero(1/$valEuro,2);
				for($i=0; $i<count($arProrrogas); $i++){
					...
					echo '<td>$ '.numero($prorValor,0).'</td>';
					echo '<td>'.numero($prorValor/$valEuro,2).' €</td>';
					echo '</tr>';
				}
?>        
            </table>
        	...
        	<td valign="top">
          	...
          	<table cellspacing="0" cellpadding="5" border="1" class="texto">
            	<tr class="ardanuy">
		        		<td>Fecha Inicio</td><td>Fecha Fin</td><td>Nombre Documento</td>
              </tr>
          ...
          <td>
            <table cellspacing="0" cellpadding="5" border="1" class="textopequeno" width="590">
              ...
              <tr>
                ...
                <td align="right"><?php echo "$ ".numero($valAdiSinIva,0); ?></td>
                <td align="right"><?php echo numero($valAdiSinIva/$valEuro,2)." €"; ?></td>
                <td align="right"><?php echo "$ ".numero($valAdiones,0); ?></td>
                <td align="right"><?php echo numero($valAdiones/$valEuro,2)." €"; ?></td>
              </tr>
     ...
     <td>
      <table cellspacing="0" cellpadding="5" border="1" class="textopequeno" width="475">
        ...
        <tr>
          ...
          <td align="right"><?php echo "$ ".numero($valAdiSinIva*$porSocio,0); ?></td>
          <td align="right"><?php echo "€ ".numero(($valAdiSinIva*$porSocio)/$valEuro,2);#conversor_divisas("COP","EUR",($valAdiSinIva*$porSocio)); ?></td>
          <td align="right"><?php echo "$ ".numero($valAdiones*$porSocio,0); ?></td>
          <td align="right"><?php echo "€ ".numero(($valAdiones*$porSocio)/$valEuro,2);#conversor_divisas("COP","EUR",($valAdiones*$porSocio)); ?></td>
        </tr>
        <tr>
